  ...
  return (
    <div className="min-h-screen flex w-full bg-[#020403]">
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-black">
        <img 
          src="https://images.unsplash.com/photo-1503376712351-1f51dbf9dfdb?q=80&w=1600" 
          alt="Luxury Car" 
        ...
        <div className="absolute top-12 left-12">
          <Link to="/" className="flex items-center text-white" aria-label="Home">
            <svg width="48" height="28" viewBox="0 0 40 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        <div className="absolute top-8 left-8">
          <Link to="/" className="flex items-center gap-2 text-[#f7f3e8]/60 hover:text-[#f7f3e8] transition-colors text-sm font-medium">
            <ArrowLeft size={16} />
            Return to Home
          </Link>
        </div>
